...
/* harmony import */ var _doctor_doctor_component__WEBPACK_IMPORTED_MODULE_34__ = __webpack_require__(/*! ./doctor/doctor.component */ "./src/app/doctor/doctor.component.ts");
/* harmony import */ var _doctor_doctorlist_component__WEBPACK_IMPORTED_MODULE_35__ = __webpack_require__(/*! ./doctor/doctorlist.component */ "./src/app/doctor/doctorlist.component.ts");
...
var routes = [
    ...
    {
        path: 'doctor',
        component: _doctor_doctor_component__WEBPACK_IMPORTED_MODULE_34__["DoctorComponent"]
    },
    {
        path: 'doctorlist',
        component: _doctor_doctorlist_component__WEBPACK_IMPORTED_MODULE_35__["DoctorlistComponent"]
    },
    {
        path: 'doctor/:id',
        component: _doctor_doctor_component__WEBPACK_IMPORTED_MODULE_34__["DoctorComponent"]
...
/* harmony import */ var _doctor_doctor_component__WEBPACK_IMPORTED_MODULE_46__ = __webpack_require__(/*! ./doctor/doctor.component */ "./src/app/doctor/doctor.component.ts");
/* harmony import */ var _doctor_doctorlist_component__WEBPACK_IMPORTED_MODULE_47__ = __webpack_require__(/*! ./doctor/doctorlist.component */ "./src/app/doctor/doctorlist.component.ts");
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
            declarations: [
                ...
                _doctor_doctor_component__WEBPACK_IMPORTED_MODULE_46__["DoctorComponent"],
                _doctor_doctorlist_component__WEBPACK_IMPORTED_MODULE_47__["DoctorlistComponent"],
            ],
            imports: [
...
var DoctorComponent = /** @class */ (function (_super) {
    tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"](DoctorComponent, _super);
    function DoctorComponent(locator, route) {
        var _this = _super.call(this, locator.endpoints.DOCTOR, locator, route) || this;
        _this.locator = locator;
        _this.route = route;
        return _this;
    }
    DoctorComponent.prototype.validateForm = function (form) {
        var flag = true;
        var validator = this.serviceLocator.dataValidator;
    ...
    DoctorComponent.prototype.populateForm = function (form, data) {
        form.id = data.id;
    ...
    DoctorComponent.prototype.parseDate = function (dateString) {
        if (dateString) {
            return new Date(dateString);
        }
        return null;
    };
    DoctorComponent.prototype.validateAlphabetInput = function (event) {
    ...
    DoctorComponent.prototype.validateQuantity = function (event) {
    ...
    DoctorComponent.prototype.onUpload = function (userform) {
        this.submit();
        console.log(this.form.data.id + '---- after submit');
    };
    DoctorComponent.prototype.submit = function () {
        var _self = this;
    ...
    DoctorComponent.prototype.validateNumber = function (event) {
    ...
    DoctorComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            ...
            styles: [__webpack_require__(/*! ./doctor.component.css */ "./src/app/doctor/doctor.component.css")]
        }),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_service_locator_service__WEBPACK_IMPORTED_MODULE_3__["ServiceLocatorService"], _angular_router__WEBPACK_IMPORTED_MODULE_4__["ActivatedRoute"]])
    ], DoctorComponent);
...
/***/ "./src/app/doctor/doctorlist.component.css":
/*!*************************************************!*\
  !*** ./src/app/doctor/doctorlist.component.css ***!
  \*************************************************/
/*! no static exports found */
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL2RvY3Rvci9kb2N0b3JsaXN0LmNvbXBvbmVudC5jc3MifQ== */"

/***/ }),

/***/ "./src/app/doctor/doctorlist.component.html":
/*!**************************************************!*\
  !*** ./src/app/doctor/doctorlist.component.html ***!
  \**************************************************/
/*! no static exports found */
...
var DoctorlistComponent = /** @class */ (function (_super) {
    tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"](DoctorlistComponent, _super);
    function DoctorlistComponent(locator, route, httpClient) {
        var _this = _super.call(this, locator.endpoints.DOCTOR, locator, route) || this;
        _this.locator = locator;
        _this.route = route;
    ...
    DoctorlistComponent.prototype.formatDate = function (event) {
    ...
    DoctorlistComponent.prototype.convertToLocalDate = function (dateString) {
    ...
    DoctorlistComponent.prototype.validateInput = function (event, field) {
        ...
        if (field === 'mobile') {
            ...
            var paymentTermValue = Number(value);
    ...
    DoctorlistComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            ...
            template: __webpack_require__(/*! ./doctorlist.component.html */ "./src/app/doctor/doctorlist.component.html"),
            styles: [__webpack_require__(/*! ./doctorlist.component.css */ "./src/app/doctor/doctorlist.component.css")]
        }),
...
module.exports = __webpack_require__(/*! C:\Rays Software\p10\proect10_FrontCtl-main\ORSProject10-UI Fctl\src\main.ts */"./src/main.ts");
